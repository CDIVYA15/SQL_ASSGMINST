...
#4
select employees.first_name, employees.last_name, employees.hire_date, departments.department_id from departments join employees
on employees.employee_id = departments.manager_id;



#5
select concat_ws(",",employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,commission_pct,manager_id,department_id) as " THE OUT PUT" From employees;
...
#7
select concat(first_name,',',last_name) as "NAME" , concat(hire_date,',') as "START DATE" from employees;
...
#10
select employees.first_name,employees.last_name,employees.salary,employees.commission_pct,departments.department_id from employees join departments
on employees.employee_id = departments.manager_id
order by salary;
...
#2(1)
select min_salary,max_salary,avg(salary),commission_pct from employees join jobs
on employees.job_id = jobs.job_id
group by salary;
...
#3
select count(employee_id) as count from employees join departments
on employees.employee_id = departments.department_id;


#4
select departments.department_name,departments.department_id ,salary,employees.first_name,employees.last_name from employees join departments
on employees.employee_id = departments.department_id;
...
#6
select employees.first_name,employees.last_name,employees.commission_pct,department_id, 
case
...
#9
select first_name, last_name, manager_id, sum(salary) as salaries from employees 
group by salary
...
#11
select first_name,last_name,salary,department_id,manager_id from employees 
group by last_name
having last_name like "_a%";


#12
select sum(salary) as salary , department_id from employees 
group by department_id;


#13
select max(salary) as salary ,department_id from employees ;
...
#4
select concat(employee_id,"00","E")  from employees ;
...
#9
select street_address,substr(street_address,locate(" ",street_address)+1,locate(" ",street_address,locate(" ",street_address)+1)-locate(" ",street_address)) "Word" from locations;



#10
select lower(concat(first_name,"@systechusa.com")) as emali from employees;

#11
select concat( first_name,' ',last_name ) "full name" ,job_title from employees join jobs
on employees.job_id = jobs.job_id
...
where city in('South San Francisco');
...
#2
select distinct e.job_id,d.location_id from employees e join departments d where e.department_id = d.department_id and e.department_id = 4;
...
#5
select last_name,job_title,depatment_name, department_id from emp_details_view;
...
#10
select concat(e.first_name,'',e.last_name) " EMPLOYEE NAME" , E.hire_date " Emp_Hire_date", concat(m.first_name,'',m.last_name) "Mnager Name" ,m.hire_date 'Manager_Hire_Date'
